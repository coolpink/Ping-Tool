...
<?php foreach ($this->getColumns() as $column): ?>
<?php if ($label = $this->getLabelForColumn($column)): ?>    $this->widgetSchema->setLabel('<?php echo $column->getFieldName() ?>', '<?php echo $label ?>');<?php endif; ?>
<?php endforeach; ?>


<?php foreach ($this->getColumns() as $column): ?>
<?php if ($help = $this->getHelpForColumn($column)): ?>    $this->widgetSchema->setHelp('<?php echo $column->getFieldName() ?>', '<?php echo $help ?>');<?php endif; ?>
<?php endforeach; ?>


<?php if ($groups = $this->getGroupedJson()): ?>
    $this->setGroupedFields(<?php echo $groups; ?>);
<?php endif; ?>


<?php if ($titlemap = $this->getTitleMap()): ?>
    $this->setTitleMap("<?php echo $titlemap; ?>");
<?php endif; ?>
